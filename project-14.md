...
On the Jenkins-Ansible server, install the PLOT PLUGIN and ARTIFACTORY PLUGIN and set it up.Add the artifactory server IP to the JFROG global configuration
